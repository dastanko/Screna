...
{
    class AudioRenderClient : IDisposable
    {
        IAudioRenderClient audioRenderClientInterface;

        public AudioRenderClient(IAudioRenderClient audioRenderClientInterface)
        {
        ...
        public void ReleaseBuffer(int numFramesWritten, int bufferFlags = 0)
        {
